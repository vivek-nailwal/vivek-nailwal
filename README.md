...
|--------|------|------------|
| [Walmart Customer Purchase Analysis](https://github.com/vivek-nailwal/walmart-confidenceInterval_and_clt) | Python | Applied CLT, confidence intervals & EDA to analyze customer spending behavior |
